[[header]]
:description: RISC-V Matrix Specification
:company: RISC-V.org
:revdate: 09/2024
:revnumber: 0.5a
...
// Yaoyang Zhou's personal draft (built in BOSC), based off Stream Computing
...
Copyright © 2022-2024 Stream Computing Inc. 2025 Beijing Institute of Open Source Chip
